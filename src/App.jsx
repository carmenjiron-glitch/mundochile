...
function TarjetaEvento({ev,diaDe,clientes,pares,interpretes,proveedores=[],onClick}) {
  ...
  return (
    <div onClick={onClick}
      ...
      {cliente?.nombre_contacto&&<div style={{fontSize:"7px",fontWeight:"500",color:"#6B6B6B",fontStyle:"italic",marginBottom:"8px"}}>Contacto: {cliente.nombre_contacto}</div>}
...
function ModalDetalle({evento,clientes,interpretes,pares,perfil,onEditar,onEliminar,onCerrar,onVerFicha,addToast}) {
  ...
  const B_EST_D=(e)=>e==="Facturado"?{bg:"#E3F2FD",c:"#11519A",b:"#11519A"}:{bg:"#FFEB3B",c:"#9E2020",b:"#F9A825"};
