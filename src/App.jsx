...
const B_EST=(e)=>e==="Facturado"?{bg:"#FFFFFF",c:"#1A1A1A",b:"#E3F2FD"}:{bg:"#FFFFFF",c:"#1A1A1A",b:"#FFEB3B"};
...
function ModalDetalle({evento,clientes,interpretes,pares,perfil,onEditar,onEliminar,onCerrar,onVerFicha,addToast}) {
  ...
  const B_EST_D=(e)=>e==="Facturado"?{bg:"#FFFFFF",c:"#1A1A1A",b:"#E3F2FD"}:{bg:"#FFFFFF",c:"#1A1A1A",b:"#FFEB3B"};
