          ...
          {celdas.map((dia,i)=>{
            ...
            return <div key={i} onClick={()=>{setDiaActual(iso);setVista("dia");}}
              ...
              <div style={{marginBottom:"4px",display:"flex",alignItems:"baseline",gap:"4px"}}>
                ...
                <span style={{fontSize:"10px",color:"#6B7280",fontWeight:"400"}}>{fecha.toLocaleDateString('es-CL',{weekday:'short'}).toUpperCase()} · {fecha.toLocaleDateString('es-CL',{month:'short'}).toUpperCase()}</span>
              </div>
